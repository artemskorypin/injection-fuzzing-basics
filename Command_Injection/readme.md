...
- «Разведочные» команды вроде `id`, `whoami`, `uname` предпочтительнее, чем сразу жёсткие действия — это соответствует идее репозитория: **сначала детект и минимальная разведка, потом уже тяжёлые вещи из внешних источников.**
